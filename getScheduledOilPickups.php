    ...
    foreach($full as $scheduled){        
        echo "<tr id='p$scheduled[schedule_id]' class='kl heading'>
                <td style='vertical-align:middle;'>
                    ...
                    <input type='checkbox' style='cursor:pointer;width:10px;height:50px;z-index:9999;' xlr='".$scheduled['account_no']."' rel='".$scheduled['schedule_id']."' class='setThisRoute'  title='schedule id:$scheduled[schedule_id] | account id:".$scheduled['account_no']." '/>
