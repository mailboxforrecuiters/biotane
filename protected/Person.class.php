...
class Person{
     ...
     public $approved;
     public $oil_access;
     public $bakery_access;
     public $grease_access;
     public $asset_access;
     public $organics_access;
     function __construct($id = NULL){ 
        ...
        $db = new Database();  
        $pull = $db->where("user_id","$ix")->get("iwp_users","*");
        ...
        $this->changed               = $pull[0]['changed'];
        $this->approved              = $pull[0]['approved'];
