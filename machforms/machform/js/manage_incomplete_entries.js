...
$(function(){
	...
	$("#dialog-export-entries a").click(function(e){
		...
		if(full_selection == 1){ //all entries being selected
			window.location.href = 'export_entries.php?type='+ export_type +'&form_id=' + form_id + '&incomplete_entries='+ $("#entries_table").data("incomplete") + '&' + selected_fields;
		}else{
			if(selected_checkboxes.length > 0){ //some entries being selected
				...
				window.location.href = 'export_entries.php?type='+ export_type +'&form_id=' + form_id + '&entries_id=' + selected_entries_id.join(',') + '&incomplete_entries='+ $("#entries_table").data("incomplete") + '&' + selected_fields;
