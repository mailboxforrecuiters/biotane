...
define('MF_DB_NAME', '702797_test'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', '702797_dawgy'); //Your database username
define('MF_DB_PASSWORD', 'Quyle714'); //Your database users password
define('MF_DB_HOST', 'mariadb-049.wc1.lan3.stabletransit.com'); //The hostname for your database
