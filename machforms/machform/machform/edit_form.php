				...
				<form style="display: block;" id="element_properties" action="" onsubmit="return false;">
					...
					<div id="element_properties_form">
						...
						<li class="rightCol" id="prop_element_size">
							...
							Field Size 
							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="This property sets the visual appearance of the field in your form. It does not limit nor increase the amount of data that can be collected by the field."/>
							</label>
						...
						<li class="rightCol" id="prop_name_format">
							...
							Name Format 
							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Two formats available. A normal name field, or an extended name field with title and suffix."/>
							</label>
						...
						<li class="leftCol" id="prop_options">
							...
							<span id="element_unique_span" style="display: block">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Checking this rule will verify that the data entered into this field is unique and has not been submitted previously."/>  
							</span>
							<span id="element_readonly_span" style="display: block">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="If enabled, users won't be able to change the value of this field."/>  
							</span>
							</fieldset>
						</li>
						...
						<li class="rightCol" id="prop_access_control">
							...
							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="This is the default option. The field will be accessible by anyone when the form is made public."/> 
							...
							<span style="display: block;margin: 1px 0">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Field will not be shown to users when the form is made public. Useful to collect information that is not entered by the users (e.g. populated from URL parameters)"/>
							</span>
							...
							<span id="admin_only_span">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Similar as hidden, but the field can't be used to collect any data from the public form. The field will only visible inside MachForm entry manager. Useful to add additional information to a submitted entry."/>
							</span>
							</fieldset>
						</li>
						...
						<li class="clear" id="prop_choice_max_entry">
							...
							<span>	
									...
									<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Limit the number of entries per choice option. Once a choice option has reached the maximum limit, it won't be available again for future selection. This is useful for reservation or booking form."/>
						...
						<li class="clear" id="prop_default_value_text">
							...
							<div class="left" style="padding-bottom: 5px">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="The field will be prepopulated with the text you enter."/>
							</div>
							...
							<div class="left" style="padding-left: 15px;padding-bottom: 5px">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="The field will be prepopulated with random letters, numbers or both."/>
							</div>
							...
							<span id="prop_default_value_text_autohide_span">	
									...
									<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="As soon as the user types in the field, the default value will be automatically removed. Useful to provide short hint that describe the expected value of the field.<br/><br/>Tech terms: The default value will be used for the 'placeholder' attribute"/>
							</span>
						...
						<li class="clear" id="prop_default_date">
							...
							Default Date
							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Use the format ##/##/#### or any English date words, such as 'today', 'tomorrow', 'last friday', '+1 week', 'last day of next month', '3 days ago', 'monday next week'"/>
							</label>
						...
						<li class="clear" id="prop_default_time">
							...
							Default Time
							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Example values: 'now', '+5 minute', '+2 hour', '-10 minute', '+2 hour 30 minute'"/>
							</label>
						...
						<li class="clear" id="prop_custom_css">
							...
							Custom CSS Class
							<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="This is an advanced option. You can add custom CSS classnames to the parent element of the field. This is useful if you would like to customize the styling for each of your field using your own CSS code. These custom class names will not appear live in the form builder, only on the live form."/>
							</label>
				...
				<div id="form_properties_holder">
						...
						<form id="form_properties" action="" onsubmit="return false;">
							...
							<li id="form_prop_confirmation" class="form_prop">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="This message will be displayed after your users have successfully submitted an entry. <br/><br/>You can enter any HTML codes, Javascript codes or Merge Tags as well."/>
								</div>
							...
							<li class="clear advanced_prop form_prop" id="form_prop_resume" style="display: none;zoom: 1">
								...
								<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="You can insert merge tags and HTML codes into Resume Email Subject and Resume Email Content."/>
								</label>
							...
							<li id="form_prop_protection" class="advanced_prop form_prop">
								...
								<legend>Protection &amp; Limit</legend>
									...
									<span style="clear: both;display: block">
										...
										<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="If enabled, an image with random words will be generated and users will be required to enter the correct words in order to submit the form. This is useful to prevent abuse from bots or automated programs usually written to generate spam."/>
									...
									<span style="clear: both;display: block">
										...
										<img class="helpmsg" src="images/icons/help2.png" style="vertical-align: top" title="Use this to prevent each client from filling out your form more than the allowed limit within a certain period. This is done by comparing client's IP Address."/>
