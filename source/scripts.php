...
ReactDOM.render(<DropdownMenu config={[
    ...
    },
    {
      ...
      "submenu": [
        ...
        {
          "title": "Utility Pickups",
          "submenu": [
            { "title": <a href='scheduling.php?task=suc'>Scheduled Utility Pickups</a>},
            { "title": <a href='scheduling.php?task=ruc'>Routed Utility Pickups</a> },
            { "title":<a href='scheduling.php?task=cuc'>Completed Utility Pickups</a> }
          ]
        }
      ]
    }
